...
# Usage: curl -fsSL https://raw.githubusercontent.com/mitshe/web/main/docker/light/install.sh | bash
#
...
if docker ps -a --format '{{.Names}}' | grep -q '^mitshe$'; then
    echo -e "${YELLOW}⚠️  Container 'mitshe' already exists.${NC}"
    echo ""
...
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo "mitshe requires Clerk for authentication."
echo "Get your keys at: https://clerk.com"
echo ""
...
if [ -z "$CLERK_SECRET_KEY" ] || [ -z "$CLERK_PUBLISHABLE_KEY" ]; then
    echo ""
    echo -e "${YELLOW}⚠️  Clerk keys not provided. Starting without authentication.${NC}"
    echo "   You can add them later by recreating the container."
fi

echo ""
echo -e "${BLUE}🚀 Starting mitshe-light...${NC}"
echo ""
